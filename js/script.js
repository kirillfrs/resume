...
(function () {
    ...
    function moveSlide(move, touch = 'click') {
        ...
        if (touch.type === 'swipeleft') {
            slider.style.transform = `translateX(${move}%)`;
        }
        if (touch.type === 'swiperight') {
    ...
    function addActiveTouch(evt) {
        if (evt.type === 'swipeleft') {
            btnBack.classList.remove('slider__toggle-active');
            btnNext.classList.add('slider__toggle-active');
        }
        if (evt.type === 'swiperight') {
            btnNext.classList.remove('slider__toggle-active');
            btnBack.classList.add('slider__toggle-active');
        }
    }
